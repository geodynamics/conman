...
gmt blockmean temp.xyz -R0/660/0/600 -I1.0/1.0 > tmp
gmt surface tmp -Gtemp.grd -R0/660/0/600 -I1.0/1.0 
gmt grdtrack ../graphics/top-slab-plot.xy -Gtemp.grd > top-slab.xyT
awk '{print sqrt(($1-0)*($1-0)+(600-$2)*(600-$2)), 1300*$3}' top-slab.xyT > top-slab.lT
gmt psxy top-slab.lT -R0/200/0/600 -JX5.0i -Bxa25+l"Along Slab Distance (km)" -Bya50.0+l"Temperature (C)" -BWSen -Wred -K -X2.0i > tos.ps
...
gmt grdtrack ../graphics/top-slab-plot.xy -Gtemp.grd > top-slab.xyT
awk '{print sqrt(($1-0)*($1-0)+(600-$2)*(600-$2)), 1300*$3}' top-slab.xyT > top-slab.lT
gmt psxy top-slab.lT -R0/200/0/600 -JX5.0i -Wred,.  -K -O >> tos.ps
...
gmt grdtrack ../graphics/top-slab-plot.xy -Gtemp.grd > top-slab.xyT
awk '{print sqrt(($1-0)*($1-0)+(600-$2)*(600-$2)), 1300*$3}' top-slab.xyT > top-slab.lT
gmt psxy top-slab.lT -R0/200/0/600 -JX5.0i -Wgreen -O -K -X0.0i >> tos.ps
...
gmt grdtrack ../graphics/top-slab-plot.xy -Gtemp.grd > top-slab.xyT
awk '{print sqrt(($1-0)*($1-0)+(600-$2)*(600-$2)), 1300*$3}' top-slab.xyT > top-slab.lT
gmt psxy top-slab.lT -R0/200/0/600 -JX5.0i -Wblue -O -K >> tos.ps
...
awk '{if(NR>2) print ($2,$3,$6) }' xab > temp.xyz
gmt blockmean temp.xyz -R0/660/0/600 -I1.0/1.0 > tmp
gmt surface tmp -Gtemp.grd -R0/660/0/600 -I1/1 
gmt grdtrack ../graphics/top-slab-plot.xy -Gtemp.grd > top-slab.xyT
awk '{print sqrt(($1-0)*($1-0)+(600-$2)*(600-$2)), 1300*$3}' top-slab.xyT > top-slab.lT
gmt psxy top-slab.lT -R0/200/0/600 -JX5.0i -Worange -O -K >> tos.ps
...
gmt grdtrack ../graphics/top-slab-plot.xy -Gtemp.grd > top-slab.xyT
awk '{print sqrt(($1-0)*($1-0)+(600-$2)*(600-$2)), 1300*$3}' top-slab.xyT > top-slab.lT
gmt psxy top-slab.lT -R0/200/0/600 -JX5.0i -O -K >> tos.ps
...
gmt grdtrack ../graphics/top-slab-plot.xy -Gtemp.grd > top-slab.xyT
awk '{print sqrt(($1-0)*($1-0)+(600-$2)*(600-$2)), 1300*$3}' top-slab.xyT > top-slab.lT
gmt psxy top-slab.lT -R0/200/0/600 -JX5.0i -O -K -Wblack,. >> tos.ps
...
gmt grdtrack ../graphics/top-slab-plot.xy -Gtemp.grd > top-slab.xyT
awk '{print sqrt(($1-0)*($1-0)+(600-$2)*(600-$2)), 1300*$3}' top-slab.xyT > top-slab.lT
gmt psxy top-slab.lT -R0/200/0/600 -JX5.0i -O -Wblack,- >> tos.ps
